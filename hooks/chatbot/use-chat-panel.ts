...
export function useChatPanel() {
  ...
  async function handleSend() {
    ...
    const userMessage = { id: crypto.randomUUID(), role: AI_ROLES.USER as MessageRole, content: text }
    ...
    try {
      ...
      addMessage({ id: crypto.randomUUID(), role: AI_ROLES.ASSISTANT as MessageRole, content: data.content })
    } catch {
      addMessage({
        id: crypto.randomUUID(),
        role: AI_ROLES.ASSISTANT as MessageRole,
